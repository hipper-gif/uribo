...
const TKC_TO_URIBO: Record<string, { name: string; uribo_codes: string[]; note?: string }> = {
  ...
  '6219': { name: '水道光熱費', uribo_codes: ['water_utility', 'electricity', 'gas'], note: 'ウォーターサーバー(water_supply)は6226側。tkcImport/RECON_RULESと同じ対応にする(2026-08-26)' },
  '6223': { name: '接待交際費', uribo_codes: ['entertainment'] },
  '6224': { name: '保険料', uribo_codes: ['insurance'] },
  '6225': { name: '備品消耗品費', uribo_codes: ['supplies'] },
  '6226': { name: '福利厚生費', uribo_codes: ['water_supply', 'welfare'], note: '富士山の銘水(ウォーターサーバー)=water_supply ＋ それ以外=welfare' },
