...
const TKC_TO_URIBO: Record<string, { name: string; uribo_codes: string[]; note?: string }> = {
  ...
  '6112': { name: '旅費交通費', uribo_codes: [] },
  '6113': { name: '広告宣伝費', uribo_codes: ['hpb'] },
  '6116': { name: '採用教育費', uribo_codes: ['training', 'recruitment'] },
  '6117': { name: '外注費', uribo_codes: [], note: '対応itemなし(Twinkle代等が混入の可能性)' },
  ...
  '6216': { name: '修繕費', uribo_codes: [] },
  '6218': { name: '通信費', uribo_codes: ['microsoft', 'spotify', 'amazon_prime'] },
  '6219': { name: '水道光熱費', uribo_codes: ['water_utility', 'water_supply'] },
  '6223': { name: '接待交際費', uribo_codes: [] },
  '6224': { name: '保険料', uribo_codes: [] },
  '6225': { name: '備品消耗品費', uribo_codes: ['supplies'] },
  '6226': { name: '福利厚生費', uribo_codes: [] },
  '6227': { name: '支払手数料', uribo_codes: [] },
  '6228': { name: '会議費', uribo_codes: [] },
